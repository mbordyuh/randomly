...
class Visualize():
    ...
    def fit_tsne(self,
                 ...
                 fdr=1):
        """
        Embedding of single cell data with t-distributed stochastic
        neighborhood embedding (tSNE) for 2D visualization. By default,
        we use Multicore-tsne implementation by Dmitry Ulyanov
        https://github.com/DmitryUlyanov/Multicore-TSNE>, if number of
        processors is great than 1. Otherwise, scikit-learn implementation
        is used. Default parametes by scikit-learn are used.
        ...
        and 50. The choice is not extremely critical since t-SNE is quite
        ...
        early_exaggeration : 'float', optional (default: 12.0)
            ...
            is not very critical. If the cost function increases during
        ...
        Returns
        -------
        Updated insance self, with self.embedding containing 2D t-SNE
        coordianates
        """
    ...
    def plot(self,
        ...
        if labels is not False:
            ...
            with plt.style.context('seaborn-paper'):
                ...
                if gene[0] == 'library':
                    cb = plt.colorbar(
                        g, cax=cax, label='library complexity', ticks=[])
                    cb.set_label(label='library complexity',
                                 fontsize=fontsize-2)
                else:
                    cb = plt.colorbar(
                        g, cax=cax, label='log2(1+TPM)', ticks=[])
                ...
                if i < n:
                    ...
                    if title:
                        ...
                        if len(marker) < 2:
                            ...
                            axs[i].set_title(
                                'list starting with ' + str(marker[0]))
